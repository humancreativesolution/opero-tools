...
export class Encryptor {
  ...
  // @ts-expect-error unused but required for encoder functionality
  ...
  public static generateRandomString(length = 128): string {
    return Encryptor.generateRandom(length, false) as string;
  }
  ...
  public static generateRandomWordArray(length = 128): lib.WordArray {
    return Encryptor.generateRandom(length, true) as lib.WordArray;
  }
  ...
  public decryptObject(cipher: CipherText): object {
    return this.update(cipher).decrypt() as object;
  }
